...
namespace ActionPlanner.Tests.StateMachines
{
    public class PersonRecognition
    {
        ...
        #region Enums
        /// <summary>
        ///  States of the "Person Recognition Test" state machine
        /// </summary>
        private enum States
        {
            /// <summary>
        ...
        /// </summary>
        private PersonRecognition_WORLD SMConfiguration;
        #endregion

        #region Constructors
        /// <summary>
        /// Creates a state machine for the Person Recognition Test.
        /// </summary>
        /// <param name="brain">HAL9000Brain instance</param>
        /// <param name="cmdMan">HAL9000CmdMan instance</param>
        public PersonRecognition(HAL9000Brain brain, HAL9000CmdMan cmdMan)
        {
            this.brain = brain;
            this.cmdMan = cmdMan;
        ...
        public Status Execute()
        {
            ...
            TextBoxStreamWriter.DefaultLog.WriteLine("HAL9000.-> Person Recognition Test SM execution finished.");
        ...
        {
            TextBoxStreamWriter.DefaultLog.WriteLine("HAL9000.-> Initializing Person Recognition Test.");

            //Load the WORLD configuration for this test
            SMConfiguration = new PersonRecognition_WORLD();
