...
namespace ActionPlanner.Tests.StateMachines
{
    public class WakeMeUp
    {
        ...
        /// </summary>
        private WakeMeUp_WORLD SMConfiguration;
        #endregion
        ...
        public WakeMeUp(HAL9000Brain brain, HAL9000CmdMan cmdMan)
        {
            this.brain = brain;
            this.cmdMan = cmdMan;
        ...
        public Status Execute()
        {
            ...
            TextBoxStreamWriter.DefaultLog.WriteLine("HAL9000.-> Wake Me Up Test SM execution finished.");
        ...
        {
            TextBoxStreamWriter.DefaultLog.WriteLine("HAL9000.-> Initializing Wake Me Up test.");

            //Load the WORLD configuration for this test
            SMConfiguration = new WakeMeUp_WORLD();
