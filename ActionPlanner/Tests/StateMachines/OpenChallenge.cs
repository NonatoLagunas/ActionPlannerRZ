...
namespace ActionPlanner.Tests.StateMachines
{
    public class OpenChallenge
    {
        ...
        #region Enums
        /// <summary>
        ///  States of the "Open Challenge" state machine
        /// </summary>
        private enum States
        {
            /// <summary>
        ...
        /// </summary>
        private OpenChallenge_WORLD SMConfiguration;
        #endregion

        #region Constructors
        /// <summary>
        /// Creates a state machine for the Open Challenge test.
        /// </summary>
        /// <param name="brain">HAL9000Brain instance</param>
        /// <param name="cmdMan">HAL9000CmdMan instance</param>
        public OpenChallenge(HAL9000Brain brain, HAL9000CmdMan cmdMan)
        {
            this.brain = brain;
            this.cmdMan = cmdMan;
        ...
        public Status Execute()
        {
            ...
            TextBoxStreamWriter.DefaultLog.WriteLine("HAL9000.-> Open Challenge SM execution finished.");
        ...
        {
            TextBoxStreamWriter.DefaultLog.WriteLine("HAL9000.-> Initializing Open Challenge test.");

            //Load the WORLD configuration for this test
            SMConfiguration = new OpenChallenge_WORLD();
