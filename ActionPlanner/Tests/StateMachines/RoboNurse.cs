...
namespace ActionPlanner.Tests.StateMachines
{
    public class RoboNurse
    {
        ...
        /// </summary>
        private RoboNurse_WORLD SMConfiguration;
        #endregion
        ...
        public RoboNurse(HAL9000Brain brain, HAL9000CmdMan cmdMan)
        {
            this.brain = brain;
            this.cmdMan = cmdMan;
        ...
        public Status Execute()
        {
            ...
            TextBoxStreamWriter.DefaultLog.WriteLine("HAL9000.-> RoboNurse SM execution finished.");
        ...
        {
            TextBoxStreamWriter.DefaultLog.WriteLine("HAL9000.-> Initializing Robo Nurse test.");

            //Load the WORLD configuration for this test
            SMConfiguration = new RoboNurse_WORLD();
